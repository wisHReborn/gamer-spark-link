...
// Custom Discord Icon as Lucide doesn't have it
const DiscordIcon = ({ className, size = 24, fill = "currentColor" }: { className?: string, size?: number, fill?: string }) => (
  <svg
    viewBox="0 0 24 24"
    width={size}
    height={size}
...
const donateOptions = [
  { name: "easydonate", desc: "ทุกช่องทาง PromptPay / TrueMoney / Credit Card", url: "https://ezdn.app/preee_reborn", featured: true },
];
...
const gearItems = [
  ...
  { Icon: MemoryStick, label: "Ram", value: '16.0 GB' },
      ...
      <Section id="community" eyebrow="04" title={L.commTitle} subtitle={L.commSub} className="bg-theme-community relative">
        <div className="relative overflow-hidden rounded-[2.5rem] border border-border bg-card p-10 sm:p-20 text-center group shadow-2xl animate-float-slow">
          ...
          <div className="relative z-10">
            ...
            >
              <DiscordIcon className="size-7" fill="currentColor" />
              {L.joinDiscord}
            </a>
          </div>
        </div>
